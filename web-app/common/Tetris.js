...
Tetris.hold = function (game) {
    ...
    if (game.can_hold) {
        if (game.held_tetromino) {
            let t = game.current_tetromino;
            game.current_tetromino = Tetris[game.held_tetromino.block_type + '_tetromino'];
            held_tetromino = t;
        } else {
            held_tetromino = game.current_tetromino;
            const [next_tetromino, bag] = game.bag();
            game.current_tetromino = Tetris[game.next_tetromino.block_type + '_tetromino'];
